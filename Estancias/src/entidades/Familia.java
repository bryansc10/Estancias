...
public class Familia {
	...
	public Familia(int id_familia, String nombre, int edad_minima, int edad_maxima, int num_hijos, String email,
			int id_casa_familia) {
	...
	public String toString() {
		return String.format("%s %s %s %s %s %s %s\n", id_familia, nombre, edad_minima, edad_maxima, num_hijos, email,
				id_casa_familia);
	}
}
